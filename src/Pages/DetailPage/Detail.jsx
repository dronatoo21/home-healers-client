...
const Detail = () => {
    ...
    const idURL = `https://homehealers-project-server-ten.vercel.app/services/${id}`
    useEffect(() => {
        fetch(idURL)
        .then(res => res.json())
        .then(data => {
    ...
    const emailURL = `https://homehealers-project-server-ten.vercel.app/myServices?yourEmail=${service?.yourEmail}`;
    useEffect(()=>{
        fetch(emailURL)
        .then(res => res.json())
        .then(data => {
        ...
        const handleBookService = e => {
            ...
            fetch('https://homehealers-project-server-ten.vercel.app/bookings', {
            method: 'POST',
            headers: {
    ...
    return (
        <div className="my-8 mx-5 lg:mx-0">
            ...
            <div className="card my-5 bg-base-100 shadow-xl">
              <figure><img className="w-full lg:h-[600px]" src={service?.pictureUrl} alt="Shoes"/></figure>
              <div className="card-body">
